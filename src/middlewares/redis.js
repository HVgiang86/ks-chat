...
const endpoint = process.env.REDIS_ENDPOINT_URL || '13.239.122.152:6379';
...
module.exports = {
  ...
  hmset: (key = 'key', values = []) => new Promise((a, b) => client.hmset(key, values, resolvePromise(a, b))),
  exists: (key = 'key') => new Promise((a, b) => client.exists(key, resolvePromise(a, b))),
  hexists: (key = 'key', key2 = '') => new Promise((a, b) => client.hexists(key, key2, resolvePromise(a, b))),
  ...
  zadd: (key = 'key', key2 = '', value) => new Promise((a, b) => client.zadd(key, key2, value, resolvePromise(a, b))),
  zaddEmpty: (key = 'key') =>
  ...
  sadd: (key = 'key', value) => new Promise((a, b) => client.sadd(key, value, resolvePromise(a, b))),
  hmget: (key = 'key', key2 = '') => new Promise((a, b) => client.hmget(key, key2, resolvePromise(a, b))),
  sismember: (key = 'key', key2 = '') => new Promise((a, b) => client.sismember(key, key2, resolvePromise(a, b))),
  smembers: (key = 'key') => new Promise((a, b) => client.smembers(key, resolvePromise(a, b))),
  srem: (key = 'key', key2 = '') => new Promise((a, b) => client.srem(key, key2, resolvePromise(a, b))),
};
